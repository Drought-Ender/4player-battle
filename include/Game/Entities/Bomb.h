...
struct Parms : public EnemyParmsBase {
	struct ProperParms : public Parameters {
		inline ProperParms()
		    ...
		    , mDamageToEnemies(this, 'fp01', "�G�ւ̃_���[�W", 250.0f, 0.0f, 2000.0f) // 'damage to enemies'
		    , mBlastRangeHeight(this, 'fp02', "�����͈͍���+-", 50.0f, 0.0f, 50.0f)   // 'blast range height +-'
		    , mDamageLimit(this, 'ip01', "�_���[�W���~�b�g", 2, 1, 10)                // 'damage limit'
		    , mTriggerLimit(this, 'ip02', "�U�����~�b�g", 50, 0, 100)                 // 'induction limit'
		{
		}

...
struct Parms : public EnemyParmsBase {
	struct ProperParms : public Parameters {
		inline ProperParms()
		    ...
		    , mSingleNectarChance(this, 'fp01', "�����[�g", 1.0f, 0.0f, 1.0f)       // 'nectar rate'
		    , mDoubleNectarChance(this, 'fp02', "��x2���[�g", 1.0f, 0.0f, 1.0f)     // 'nectar x2 rate'
		    , mMititesChance(this, 'fp03', "�^�}�S���Vx10���[�g", 1.0f, 0.0f, 1.0f) // 'mitite x10 rate'
		    , mSpicyChance(this, 'fp04', "�ԃh�[�s���O���[�g", 1.0f, 0.0f, 1.0f)    // 'red doping rate'
		    , mBitterChance(this, 'fp05', "���h�[�s���O���[�g", 1.0f, 0.0f, 1.0f)   // 'black doping rate'
		{
		}

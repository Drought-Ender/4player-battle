...
FloatingIcon::~FloatingIcon() { DebugReport("FloatingIcon::setupViewMtx(Graphics& gfx)\n"); }

Vector3f FloatingIcon::getPosition() { return *mPosition; }
...
f32 FloatingIcon::getSize() { return ICON_SIZE; }
...
Vector3f HoveringFloatingIcon::getPosition() { return Vector3f(mPosition->x, mPosition->y + mYOffset, mPosition->z); }

...
void StateMachine<Game::ItemDownFloor::Item>::init(Game::ItemDownFloor::Item*) { }
 ...
 * Size:	000064
 */
void StateMachine<Game::ItemDownFloor::Item>::create(int states)
{
	mLimit          = states;
	mCount          = 0;
	mStates         = new FSMState<Game::ItemDownFloor::Item>*[mLimit];
 ...
 * Size:	00009C
 */
void StateMachine<Game::ItemDownFloor::Item>::transit(Game::ItemDownFloor::Item* section, int stateID, StateArg* arg)
{

	int stateIndex              = mIdToIndexArray[stateID];
	Game::ItemDownFloor::State* currentState = section->mCurrentState;
	if (currentState) {
	...
	Game::ItemDownFloor::State* state = static_cast<Game::ItemDownFloor::State*>(mStates[stateIndex]);
 ...
 * Size:	000084
 */
void StateMachine<Game::ItemDownFloor::Item>::registerState(FSMState<Game::ItemDownFloor::Item>* state)
{
	if (mCount >= mLimit) {
		return;
	}
 ...
 * Size:	000038
 */
void StateMachine<Game::ItemDownFloor::Item>::exec(Game::ItemDownFloor::Item* section)
{
...
void StateMachine<Game::ItemDownFloor::Item>::start(Game::ItemDownFloor::Item* section, int stateID, StateArg* arg)
{

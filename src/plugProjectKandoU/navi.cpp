...
void Navi::onInit(Game::CreatureInitArg* arg)
{
	...
	mScale = navi_scale;
	uVar2  = mNaviIndex;
	mCursorMatAnim->start((Sys::MatBaseAnimation*)(naviMgr->mNaviIndexArray[mNaviIndex]));
	mArrowMatAnim->start((Sys::MatBaseAnimation*)(naviMgr->mNaviIndexArray[mNaviIndex]));
}
